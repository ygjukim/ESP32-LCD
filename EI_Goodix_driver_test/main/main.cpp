...
#define INT_PIN                -1  // 12
#define RST_PIN                7  // 14
#define GOODIX_SDA             8  // 21
#define GOODIX_SCL             9  // 22
...
void touchStart() {
 if (touch.begin(INT_PIN, RST_PIN, GOODIX_I2C_ADDR_BA) != true) {
    ESP_LOGE(LOG_TAG,"GT911 module reset failed");
  } else {
    ESP_LOGI(LOG_TAG,"GT911 module reset OK");
  }
