...
unsigned long tn = 0;
void setup() {
  printf("Lovyan's LovyanGFX library Test!\n"); 
...
void loop(void)
{
	printf(F("Benchmark                Time (microseconds)\n"));

	uint32_t usecHaD = testHaD();
	printf(F("HaD pushColor            %ld\n"), usecHaD);
	delay(100);

	uint32_t usecFillScreen = testFillScreen();
	printf(F("Screen fill              %ld\n"), usecFillScreen);
	delay(100);
